...
elseif ElmType==CLASSIFIER
    ...
    trainout=(ActualOutputOfTrainData-min(min(ActualOutputOfTrainData)))/(max(max(ActualOutputOfTrainData))-min(min(ActualOutputOfTrainData)));
    ...
    testout=(ActualOutputOfTestData-min(min(ActualOutputOfTestData)))/(max(max(ActualOutputOfTestData))-min(min(ActualOutputOfTestData)));
